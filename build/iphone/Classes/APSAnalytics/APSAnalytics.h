 ...
 * to send analytic data that can be viewed on the chatLibrayCreatur Dashboard.
 *
 * For information on getting started with chatLibrayCreatur Platform Services,
