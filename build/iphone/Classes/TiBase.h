...
// in simulator we redefine to format for chatLibrayCreatur Developer console
...
{\
	NSString * exceptionName = [@"org.chatlibraycreatur." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.chatlibraycreatur";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIchatLibrayCreaturNativeItemNone = -1, 
	UIchatLibrayCreaturNativeItemSpinner = -2,
	UIchatLibrayCreaturNativeItemProgressBar = -3,
	
	UIchatLibrayCreaturNativeItemSlider = -4,
	UIchatLibrayCreaturNativeItemSwitch = -5,
	UIchatLibrayCreaturNativeItemMultiButton = -6,
	UIchatLibrayCreaturNativeItemSegmented = -7,
	
	UIchatLibrayCreaturNativeItemTextView = -8,
	UIchatLibrayCreaturNativeItemTextField = -9,
	UIchatLibrayCreaturNativeItemSearchBar = -10,
	
	UIchatLibrayCreaturNativeItemPicker = -11,
	UIchatLibrayCreaturNativeItemDatePicker = -12,
	
	UIchatLibrayCreaturNativeItemInfoLight = -13,
	UIchatLibrayCreaturNativeItemInfoDark = -14,
	
	UIchatLibrayCreaturNativeItemDisclosure = -15,
	
	UIchatLibrayCreaturNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all chatLibrayCreatur instances of
