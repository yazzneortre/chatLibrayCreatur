...
//@interface chatLibrayCreaturObject : NSObject
//@end

@interface chatLibrayCreaturObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[chatLibrayCreaturObject class]])
		{
			for (NSString *key in [[(chatLibrayCreaturObject*)o modules] allKeys])
			{
