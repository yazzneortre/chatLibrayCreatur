...
/**
 Base class for all chatLibrayCreatur views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the chatLibrayCreatur view hierarchy (such as wrapped iOS UIViews) was touched.
