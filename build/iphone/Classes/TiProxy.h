...
//Rare exceptions to indicate a bug in the _chatlibraycreatur code (Eg, function that a subclass should have implemented)
...
/**
 The base class for chatLibrayCreatur proxies.
 */
