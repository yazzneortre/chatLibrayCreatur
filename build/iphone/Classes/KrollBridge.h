...
@interface chatLibrayCreaturObject : KrollCoverageObject {
#else
@interface chatLibrayCreaturObject : KrollObject {
#endif
@private
...
extern NSString * chatLibrayCreatur$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	chatLibrayCreaturObject *_chatlibraycreatur;
    KrollObject* console;
	BOOL shutdown;
